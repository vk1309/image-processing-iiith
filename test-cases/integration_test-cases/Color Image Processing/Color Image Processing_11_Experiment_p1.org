...
* Test Steps
  ...
  4. Select the Processing option and set the values of θ,r,Δθ&Δr by using the scrollbar and then click on the corresponding radio button
  5. Click on the Run button
  6. Repeat 3,4&5steps for different values of θ,r,Δθ&Δr
