...
* Objective
  - To view the Experiment of the Affine Transformation experiment
...
* Test Steps
  ...
  4. Select the operation,fitting and secondary image and click on the corresponding radio buttons
  5. Click on the run button
  6. Now repeat the 3,4&5 steps by using different operation and fitting values
