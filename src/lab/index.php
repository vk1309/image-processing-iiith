...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse19/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse19/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse19/exp/index.php";
$base_url = $lab_url;
